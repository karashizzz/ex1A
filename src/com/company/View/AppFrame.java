...
import com.company.Control.Analysis;
import com.company.Control.GetPackage;
...
public class AppFrame extends JFrame {
    ...
    //原地址、目的地址、搜索地址按钮
    JButton srcButton, desButton, searchButton, trackButton,stopButton;
    //容器
    JPanel jPanel;
    //滚动条
    ...
    public AppFrame() {
        ...
        //根据网卡过滤
        jMenu1 = new JMenu("  选择网卡    ");
        //设置字体
        jMenu1.setFont(new Font("", Font.BOLD, 20));
        //根据协议过滤
        jMenu2 = new JMenu("  选择协议    ");
        //设置字体
        ...
        jMenu2.add(item7);
        //根据源ip地址过滤
        srcButton = new JButton("按源IP过滤");
        //设置字体
        srcButton.setFont(new Font("", Font.BOLD, 20));
        //根据目的ip地址过滤
        desButton = new JButton("按目的IP过滤");
        //设置字体
        ...
        stopButton.setFont(new Font("", Font.ROMAN_BASELINE, 20));
                    ...
                    save.addActionListener(
                            new ActionListener() {
                                public void actionPerformed(ActionEvent e3) {
                                    ...
                                    try {
                                        FileOutputStream fos = new FileOutputStream("C:\\Users\\karashi\\Desktop\\临时文件\\软件系统与安全\\My_Net_Sniffer\\" + name + ".txt");
...
//                    panel.add(save);
                    ...
                    Analysis analysis = new Analysis(packet);
                    hm = analysis.Analyzed();
                    ...
                    if (packet.hasHeader(Http.ID)) {
                        ...
                        info.append("------------------------------------------------------------------------------\n");
                        analysis.handleHttp();
                        for (Map.Entry<String, String> me : analysis.fieldMap.entrySet()) {
                            info.append(me.getKey() + " : " + me.getValue() + "\n");
                        }
                        for (Map.Entry<String, String> me : analysis.httpParams.entrySet()) {
                            info.append(me.getKey() + " : " + me.getValue() + "\n");
                        }
                        info.append(analysis.httpresult);
                    }
